...
<body>
  <div class="receipt">
    <div class="center">
      <div class="title">${(localStorage.getItem('systemName') || 'TARMFOOD').toUpperCase()}</div>
          ...
          <CardContent>
            <div className="bg-white text-black p-6 rounded-lg border-2 border-dashed border-gray-300 font-mono text-sm font-bold">
              <div className="text-center mb-4">
                <h2 className="font-bold text-lg">{(localStorage.getItem('systemName') || 'TARMFood').toUpperCase()}</h2>
